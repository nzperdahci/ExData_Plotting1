...
data_file <- data.frame(data_file, stringsAsFactors = FALSE)
...
hist(as.numeric(as.character((ss$Global_active_power))),col="red",xlab="Global Active Power (kilowatts)",main="Global Active Power")
dev.off()
